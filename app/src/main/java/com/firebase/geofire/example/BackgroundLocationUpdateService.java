...
//    private WeakReference<GeoFireSetLocation> mFireSetLocationWeakReference;
//    void setWeakReference(GeoFireSetLocation geoFireSetLocation) {
//        mFireSetLocationWeakReference = new WeakReference<>(geoFireSetLocation);
//    }
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                try {
                    ...
                    geoFireSetLocation.setLocation(geoFire, "firebase-hq",mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude());
                } catch (Exception e) {
