 ...
 */
public final class GeoQueryEventListener extends GeoEventListener implements com.firebase.geofire.GeoQueryEventListener {
    ...
    public GeoQueryEventListener() {
        this(true, true, true);
    }

    /** Allows you to specify exactly which of the events you want to record. */
    public GeoQueryEventListener(boolean recordEntered, boolean recordMoved, boolean recordExited) {
