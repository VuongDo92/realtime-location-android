...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.e(TAG, "location changed {long: "  + location.getLatitude() + " }");

        lastKnownLocation = location;
        try {
            GeoFire geoFire = geoFireSetLocation.newTestGeoFire();
            geoFireSetLocation.setLocation(geoFire, "firebase-hq",lastKnownLocation.getLatitude(), lastKnownLocation.getLongitude());
        } catch (Exception e) {
